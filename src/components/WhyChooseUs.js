...
const WhyChooseUs = () => {
  return (
    <div className="promoContainer chooseus-bgc">
      ...
      <div class="row row-cols-1 row-cols-md-3 g-4 mt-5 pb-4 chooseus-gap">
        <div class="col card1">
        ...
        <div class="col card1  ">
          <div ><AiOutlineGlobal className="star-icon" /></div>
          <div class="card  border-0">
            <div className="card-title ">
              <p className='card-title-p'>Handpicked Hotels</p>
            </div>
        ...
        <div class="col card1">
          <div ><AiOutlineLike className="star-icon" /></div>
          <div class="card  border-0">
            <div className="card-title ">
              <p className='card-title-p'>Handpicked Hotels</p>
            </div>
